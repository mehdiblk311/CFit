  ...
  if (isLoading || !user?.id) {
    return (
      <div className="weight-root weight-loading">
        <p className="weight-label-mono">GATHERING METRICS...</p>
      </div>
    );
  }
    ...
    <div className="weight-root">
      <header className="weight-header">
        <div className="weight-header-left">
          ...
          <h1 className="weight-title-display">Weight Tracker</h1>
        </div>
      </header>
      ...
      <main className="weight-main">
        ...
        <section className="weight-hero-section">
          <div className="weight-hero-card">
            <span className="weight-label-mono">CURRENT WEIGHT</span>
            ...
            {trendValue !== null && (
              <div className={`weight-trend weight-trend-${trend}`}>
                ...
                <span>{trendValue} kg since last entry</span>
              </div>
            )}
          </div>
        </section>
        ...
        <div className="weight-content-grid">
          ...
          <section className="weight-form-section">
            <div className="weight-card">
              <h2 className="weight-card-title">Log Weigh-In</h2>
              <form onSubmit={handleSubmit} className="weight-form">
                <div className="weight-input-group">
                  <label className="weight-label-mono">Weight (kg)</label>
                  <input 
                    type="number" 
                    step="0.1" 
                ...
                <div className="weight-input-group">
                  <label className="weight-label-mono">Date</label>
                  <input 
                    type="date" 
                    className="weight-input" 
                    value={date} 
                ...
                <div className="weight-input-group">
                  <label className="weight-label-mono">Notes (optional)</label>
                  <input 
                    type="text" 
                    className="weight-input" 
                    value={notes} 
                ...
                >
                  {addEntryMutation.isPending ? 'Logging...' : 'Save Entry'}
                </button>
              </form>
            </div>
          </section>
          ...
          <section className="weight-chart-section">
            <div className="weight-card weight-chart-card">
              <h2 className="weight-card-title">Progress Trend</h2>
              <div className="weight-chart-container">
                {chartPath ? (
                  ...
                  <div className="weight-chart-empty">
                    <p>Not enough data to show a trend yet.</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <section className="weight-history-section">
          <h2 className="weight-section-title">Recent Entries</h2>
          {sortedEntries.length === 0 ? (
            <div className="weight-empty-state">
              <span className="material-symbols-outlined">monitor_weight</span>
              <p>Your history is empty. Start logging to see your progress!</p>
            </div>
          ) : (
